 ...
 *    WP Admin > Settings > WPDTRT Forms
 *
...
<div class="wrap">
  ...
  <h1><?php esc_attr_e( 'WPDTRT Forms', 'wp_admin_style' ); ?>: Placeholder blocks</h1>
    ...
    <div id="post-body" class="metabox-holder columns-2">
      ...
      <div id="post-body-content">
        ...
        <div class="meta-box-sortables ui-sortable">
           ...
           * then $wpdtrt_forms_datatype will be set to the default of ""
           * The user must make a selection so that we know which page to query,
           * so we show the selection box first.
           */
          if ( !isset( $wpdtrt_forms_datatype ) || ( $wpdtrt_forms_datatype === '') ) :
          ?>
          ...
          <div class="postbox">
            ...
            <div class="inside">
              ...
              <form name="wpdtrt_forms_data_form" method="post" action="">

                <input type="hidden" name="wpdtrt_forms_form_submitted" value="Y" />

                <table class="form-table">
                  <tr>
                    <th>
                      <label for="wpdtrt_forms_datatype">Please select a block type:</label>
                    </th>
                    <td>
                      <select name="wpdtrt_forms_datatype" id="wpdtrt_forms_datatype">
           ...
           * then $wpdtrt_forms_data will contain the body of the resulting JSON.
           */
          ...
          <div class="postbox">
            ...
            <div class="inside">
              ...
              <p>This data set contains <?php echo count( $wpdtrt_forms_data ); ?> blocks.</p>

              <p>The first 6 are displayed below:</p>

              <div class="wpdtrt-forms-blocks">
                <ul>
                ...
                <?php
                  ...
                  foreach( $wpdtrt_forms_data as $key => $val ) {
                    echo "<li>" . wpdtrt_forms_html_image( $key ) . "</li>\r\n";
          ...
          <div class="postbox">
            ...
            <div class="inside">
              ...
              <div class="wpdtrt-forms-data"><pre><code><?php echo "{\r\n";

                  $count = 0;
                  $max_length = 6;

                  foreach( $wpdtrt_forms_data as $key => $val ) {
                    var_dump( $wpdtrt_forms_data[$key] );
            ...
            <div class="inside">
              ...
              <form name="wpdtrt_forms_data_form" method="post" action="">
                ...
                <p>
                  ...
                  <select name="wpdtrt_forms_datatype" id="wpdtrt_forms_datatype">
                    <option value="">None</option>
                    <option value="photos" <?php selected( $wpdtrt_forms_datatype, "photos" ); ?>>Coloured blocks</option>
                    <option value="users" <?php selected( $wpdtrt_forms_datatype, "users" ); ?>>Maps</option>
                  </select>
                </p>
                <p>
