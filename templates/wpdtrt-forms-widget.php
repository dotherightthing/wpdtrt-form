 ...
 *    WP Admin > Appearance > Widgets > WPDTRT Forms
 *
...
<p>
  ...
  <span id="<?php echo $this->get_field_name('number'); ?>-tip" class="wpdtrt-forms-tip">Minimum: 1 | Maximum: <?php echo count($wpdtrt_forms_data); ?></span>
</p>
