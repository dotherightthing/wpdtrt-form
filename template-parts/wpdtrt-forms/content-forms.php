...
$data = $plugin->get_plugin_data(); // get existing plugin data (not get_api_data)
...
<div class="wpdtrt-forms">
	<form action="<?php esc_url( $_SERVER['REQUEST_URI'] ) ?>" method="post" class="wpdtrt-forms-template wpdtrt-forms-template-<?php echo $template; ?>">
	  <fieldset class="wpdtrt-forms-fieldset">
	    <legend class="wpdtrt-forms-legend wpdtrt-forms-hidden"><?php echo $data['legend']; ?></legend>
	    ...
	    <div>
	      <input type="submit" name="wpdtrt_forms_submitted" class="wpdtrt-forms-submit" value="<?php echo $data['submit']; ?>">
	    </div>
